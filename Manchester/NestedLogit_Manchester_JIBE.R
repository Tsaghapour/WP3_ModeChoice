...
### Clear memory
rm(list = ls())
rm(list= ls()[!(ls() %in% c('modelmnl','modelsht','modelsht2','modeljib'))])
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  ###traveltime
  carptime = j_timecarp * t.route.car_time; walktime = j_timewalk * t.route.walk_jibe_time; biketime = j_timebike * t.route.bike_jibe_time; ptwalktime = j_timept * t.route.pt_totalTravelTime
...
#### MODEL PEREDICTION                                           ####
# ################################################################# #
forecast_modeljib = apollo_prediction(modeljib,
                                      apollo_probabilities,
                                      apollo_inputs,
                                      prediction_settings)  

write.csv(forecast_modeljib,file = "C:/Users/e18933/OneDrive - RMIT University/WORK/JIBE/DATA Analysis/R/Manchester/forcast_modeljib.csv")
...
write.csv(estimateValues,file = "C:/Users/e18933/OneDrive - RMIT University/WORK/JIBE/DATA Analysis/R/Manchester/estimatevalues_modeljib.csv")
