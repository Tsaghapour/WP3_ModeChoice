...
apollo_control = list(
  ...
  modelDescr = "Nested logit with socio-demographics and short reoute_based measures on mode choice",
  indivID    = "tripID",
  panelData  = FALSE,
  nCores     = 6
)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  #log transformation of pois var
...
model_test = apollo_estimate(apollo_beta, apollo_fixed, apollo_probabilities, apollo_inputs)
...
#### MODEL PEREDICTION                                           ####
# ################################################################# #
forecast_modelsht = apollo_prediction(model,
                             apollo_probabilities,
                             apollo_inputs,
                             prediction_settings)  

write.csv(forecast_modelsht,file = "C:/Users/e18933/OneDrive - RMIT University/WORK/JIBE/DATA Analysis/R/Manchester/forcast_modelsht.csv")

#### Likelihood ratio tests against MNL model
# ################################################################# #
lrTest = apollo_lrTest(model1,model)                                                                                                                                                                                                                                                                                                                           
...
write.csv(estimateValues,file = "C:/Users/e18933/OneDrive - RMIT University/WORK/JIBE/DATA Analysis/R/Manchester/estimatevalues_modelsht.csv")
