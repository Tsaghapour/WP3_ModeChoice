...
library(readr)
library(dplyr)
mandatory_trips <- read.csv("/Users/tayebeh/Library/CloudStorage/OneDrive-RMITUniversity/WORK/JIBE/DATA Analysis/R/NewVISTA/mandatory_trips.csv",stringsAsFactors = TRUE)
...
apollo_probabilities=function(apollo_beta, apollo_inputs, functionality="estimate"){
  ...
  V[['walk']]  = cons_walk + age1_walk + age2_walk + age4_walk + age5_walk + age6_walk + female_walk +inc1_walk + inc2_walk + inc3_walk + inc4_walk +
    worktype2_walk + worktype3_walk + worktype4_walk + carsno_walk + bikesno_walk + worktype2_walk + worktype4_walk + attract_walk + streslnk_walk + stresjct_walk + walktime 
  V[['bike']] = cons_bike + age1_bike + age2_bike + age4_bike + age5_bike + age6_bike + female_bike + inc1_bike + inc2_bike + inc3_bike + inc4_bike +
    worktype2_bike + worktype3_bike + worktype4_bike + carsno_bike + bikesno_bike + worktype2_bike + worktype4_bike + attract_bike + streslnk_bike + stresjct_bike + biketime
...
write.csv(forecast,file = "C:/Users/e18933/OneDrive - RMIT University/WORK/JIBE/DATA Analysis/R/Manchester/probabilities_modelsht.csv")

#### Likelihood ratio tests against MNL model
# ################################################################# #
lrTest = apollo_lrTest(modelmnl,modelsht)                                                                                                                                                                                                                                                                                                                           
